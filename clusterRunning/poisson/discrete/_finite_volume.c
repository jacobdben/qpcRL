...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "poisson.discrete._finite_volume",
        "sources": [
            "poisson/discrete/_finite_volume.pyx"
        ]
    },
    "module_name": "poisson.discrete._finite_volume"
}
END: Cython Metadata */
...
#define __PYX_HAVE__poisson__discrete___finite_volume
#define __PYX_HAVE_API__poisson__discrete___finite_volume
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'poisson.discrete._finite_volume' */
...
static PyObject *__pyx_f_7poisson_8discrete_14_finite_volume_fneig(PyArrayObject *, PyObject *, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_7poisson_8discrete_14_finite_volume_inverse_ridge(PyArrayObject *, PyObject *, PyObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "poisson.discrete._finite_volume"
extern int __pyx_module_is_main_poisson__discrete___finite_volume;
int __pyx_module_is_main_poisson__discrete___finite_volume = 0;

/* Implementation of 'poisson.discrete._finite_volume' */
...
static const char __pyx_k_index_all[] = "index_all";
static const char __pyx_k_pyx_state[] = "__pyx_state";
static const char __pyx_k_reduce_ex[] = "__reduce_ex__";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_index_keep[] = "index_keep";
...
static const char __pyx_k_point_ridges[] = "point_ridges";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_ridge_points[] = "ridge_points";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_vertex_ridges[] = "vertex_ridges";
static const char __pyx_k_ridge_vertices[] = "ridge_vertices";
...
static const char __pyx_k_TODO_refactor_and_write_Docstri[] = "\n    TODO: refactor and write Docstring\n";
...
static PyObject *__pyx_n_s_index_all;
static PyObject *__pyx_n_s_index_keep;
...
static PyObject *__pyx_n_s_point_ridges;
...
static PyObject *__pyx_n_s_vertex_ridges;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_7poisson_8discrete_14_finite_volume_fneig(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_index_keep, PyObject *__pyx_v_index_all, int __pyx_v_npoints); /* proto */
static PyObject *__pyx_pf_7poisson_8discrete_14_finite_volume_2inverse_ridge(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_ridge_points, PyObject *__pyx_v_ridge_vertices, PyObject *__pyx_v_point_ridges, PyObject *__pyx_v_index_all, PyObject *__pyx_v_vertex_ridges); /* proto */
...
/* "poisson/discrete/_finite_volume.pyx":9
 * import time
 * 
...
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_1fneig(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7poisson_8discrete_14_finite_volume_fneig(PyArrayObject *__pyx_v_index_keep, PyObject *__pyx_v_index_all, int __pyx_v_npoints, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_v_index_of_points = 0;
  int __pyx_v_point;
  int __pyx_v_fneig;
  PyObject *__pyx_v_t = NULL;
  __Pyx_memviewslice __pyx_v_points_in = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_LocalBuf_ND __pyx_pybuffernd_index_keep;
  __Pyx_Buffer __pyx_pybuffer_index_keep;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("fneig", 0);
  __pyx_pybuffer_index_keep.pybuffer.buf = NULL;
  __pyx_pybuffer_index_keep.refcount = 0;
  __pyx_pybuffernd_index_keep.data = NULL;
  __pyx_pybuffernd_index_keep.rcbuffer = &__pyx_pybuffer_index_keep;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_index_keep.rcbuffer->pybuffer, (PyObject*)__pyx_v_index_keep, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 9, __pyx_L1_error)
  }
  __pyx_pybuffernd_index_keep.diminfo[0].strides = __pyx_pybuffernd_index_keep.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_index_keep.diminfo[0].shape = __pyx_pybuffernd_index_keep.rcbuffer->pybuffer.shape[0];

  /* "poisson/discrete/_finite_volume.pyx":17
 *     cdef int id_point
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_npoints); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_4 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_5numpy_dtype), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 17, __pyx_L1_error)
  ...
  /* "poisson/discrete/_finite_volume.pyx":18
 * 
 *     t = np.zeros(npoints, dtype=np.dtype("i"))
 *     t[index_keep] = np.ones(len(index_keep), dtype=np.dtype("i"))             # <<<<<<<<<<<<<<
 *     cdef int [:] points_in = t
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_5 = PyObject_Length(((PyObject *)__pyx_v_index_keep)); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 18, __pyx_L1_error)
  __pyx_t_4 = PyInt_FromSsize_t(__pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_5numpy_dtype), __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (unlikely(PyObject_SetItem(__pyx_v_t, ((PyObject *)__pyx_v_index_keep), __pyx_t_2) < 0)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "poisson/discrete/_finite_volume.pyx":19
 *     t = np.zeros(npoints, dtype=np.dtype("i"))
 *     t[index_keep] = np.ones(len(index_keep), dtype=np.dtype("i"))
 *     cdef int [:] points_in = t             # <<<<<<<<<<<<<<
 * 
 *     index_of_points = []
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_t, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_v_points_in = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "poisson/discrete/_finite_volume.pyx":21
 *     cdef int [:] points_in = t
 * 
 *     index_of_points = []             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_v_index_of_points = ((PyObject*)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "poisson/discrete/_finite_volume.pyx":22
 * 
 *     index_of_points = []
 *     for point in range(len(index_all)):             # <<<<<<<<<<<<<<
 *         index_of_points.append([])
 ...
 */
  if (unlikely(__pyx_v_index_all == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 22, __pyx_L1_error)
  }
  __pyx_t_5 = PyList_GET_SIZE(__pyx_v_index_all); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_t_7 = __pyx_t_5;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_point = __pyx_t_8;

    /* "poisson/discrete/_finite_volume.pyx":23
 *     index_of_points = []
 *     for point in range(len(index_all)):
 *         index_of_points.append([])             # <<<<<<<<<<<<<<
 *         for fneig in index_all[point]:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_9 = __Pyx_PyList_Append(__pyx_v_index_of_points, __pyx_t_2); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(0, 23, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

    /* "poisson/discrete/_finite_volume.pyx":24
 *     for point in range(len(index_all)):
 *         index_of_points.append([])
 *         for fneig in index_all[point]:             # <<<<<<<<<<<<<<
 *             if points_in[fneig]:
 ...
 */
    ...
    __pyx_t_2 = __Pyx_GetItemInt_List(__pyx_v_index_all, __pyx_v_point, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    if (likely(PyList_CheckExact(__pyx_t_2)) || PyTuple_CheckExact(__pyx_t_2)) {
      __pyx_t_4 = __pyx_t_2; __Pyx_INCREF(__pyx_t_4); __pyx_t_10 = 0;
      __pyx_t_11 = NULL;
    } else {
      __pyx_t_10 = -1; __pyx_t_4 = PyObject_GetIter(__pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 24, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
    ...
    for (;;) {
      if (likely(!__pyx_t_11)) {
        if (likely(PyList_CheckExact(__pyx_t_4))) {
          ...
          __pyx_t_2 = PyList_GET_ITEM(__pyx_t_4, __pyx_t_10); __Pyx_INCREF(__pyx_t_2); __pyx_t_10++; if (unlikely(0 < 0)) __PYX_ERR(0, 24, __pyx_L1_error)
          #else
          __pyx_t_2 = PySequence_ITEM(__pyx_t_4, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          #endif
        } else {
          if (__pyx_t_10 >= PyTuple_GET_SIZE(__pyx_t_4)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_2 = PyTuple_GET_ITEM(__pyx_t_4, __pyx_t_10); __Pyx_INCREF(__pyx_t_2); __pyx_t_10++; if (unlikely(0 < 0)) __PYX_ERR(0, 24, __pyx_L1_error)
          #else
          __pyx_t_2 = PySequence_ITEM(__pyx_t_4, __pyx_t_10); __pyx_t_10++; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 24, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_2);
          #endif
      ...
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      __pyx_v_fneig = __pyx_t_12;

      /* "poisson/discrete/_finite_volume.pyx":25
 *         index_of_points.append([])
 *         for fneig in index_all[point]:
 *             if points_in[fneig]:             # <<<<<<<<<<<<<<
 *                 index_of_points[point].append(fneig)
 * 
 */
      __pyx_t_13 = __pyx_v_fneig;
      __pyx_t_12 = -1;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_points_in.shape[0];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_12 = 0;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_points_in.shape[0])) __pyx_t_12 = 0;
      if (unlikely(__pyx_t_12 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_12);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_14 = ((*((int *) ( /* dim=0 */ (__pyx_v_points_in.data + __pyx_t_13 * __pyx_v_points_in.strides[0]) ))) != 0);
      if (__pyx_t_14) {

        /* "poisson/discrete/_finite_volume.pyx":26
 *         for fneig in index_all[point]:
 *             if points_in[fneig]:
 *                 index_of_points[point].append(fneig)             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_2 = __Pyx_GetItemInt_List(__pyx_v_index_of_points, __pyx_v_point, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_2);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_fneig); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_9 = __Pyx_PyObject_Append(__pyx_t_2, __pyx_t_3); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(0, 26, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "poisson/discrete/_finite_volume.pyx":28
 *                 index_of_points[point].append(fneig)
 * 
 *     return index_of_points             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_INCREF(__pyx_v_index_of_points);
  __pyx_r = __pyx_v_index_of_points;
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_index_keep.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("poisson.discrete._finite_volume.fneig", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_index_keep.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_index_of_points);
  __Pyx_XDECREF(__pyx_v_t);
  __PYX_XDEC_MEMVIEW(&__pyx_v_points_in, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_1fneig(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_1fneig(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_index_keep = 0;
  PyObject *__pyx_v_index_all = 0;
  int __pyx_v_npoints;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("fneig (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_index_keep,&__pyx_n_s_index_all,&__pyx_n_s_npoints,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_index_keep)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_index_all)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fneig", 1, 3, 3, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_npoints)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fneig", 1, 3, 3, 2); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fneig") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_index_keep = ((PyArrayObject *)values[0]);
    __pyx_v_index_all = ((PyObject*)values[1]);
    __pyx_v_npoints = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_npoints == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fneig", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("poisson.discrete._finite_volume.fneig", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_index_keep), __pyx_ptype_5numpy_ndarray, 1, "index_keep", 0))) __PYX_ERR(0, 9, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_index_all), (&PyList_Type), 1, "index_all", 1))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_r = __pyx_pf_7poisson_8discrete_14_finite_volume_fneig(__pyx_self, __pyx_v_index_keep, __pyx_v_index_all, __pyx_v_npoints);
...
static PyObject *__pyx_pf_7poisson_8discrete_14_finite_volume_fneig(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_index_keep, PyObject *__pyx_v_index_all, int __pyx_v_npoints) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_index_keep;
  __Pyx_Buffer __pyx_pybuffer_index_keep;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_index_keep.diminfo[0].strides = __pyx_pybuffernd_index_keep.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_index_keep.diminfo[0].shape = __pyx_pybuffernd_index_keep.rcbuffer->pybuffer.shape[0];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_7poisson_8discrete_14_finite_volume_fneig(__pyx_v_index_keep, __pyx_v_index_all, __pyx_v_npoints, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "poisson/discrete/_finite_volume.pyx":31
 * 
 * 
...
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_3inverse_ridge(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7poisson_8discrete_14_finite_volume_inverse_ridge(PyArrayObject *__pyx_v_ridge_points, PyObject *__pyx_v_ridge_vertices, PyObject *__pyx_v_point_ridges, PyObject *__pyx_v_index_all, PyObject *__pyx_v_vertex_ridges, CYTHON_UNUSED int __pyx_skip_dispatch) {
  CYTHON_UNUSED __Pyx_memviewslice __pyx_v_cython_ridge_points = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_point;
  int __pyx_v_vertex;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("inverse_ridge", 0);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_ridge_points.rcbuffer->pybuffer, (PyObject*)__pyx_v_ridge_points, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 31, __pyx_L1_error)
  }
  ...
  /* "poisson/discrete/_finite_volume.pyx":35
 *                     list vertex_ridges):
 * 
 ...
 * 
 */
  __pyx_t_1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_v_ridge_points), PyBUF_WRITABLE); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 35, __pyx_L1_error)
  __pyx_v_cython_ridge_points = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "poisson/discrete/_finite_volume.pyx":38
 *     cdef int i, j, point, vertex
 * 
 ...
 */
  __pyx_t_2 = PyObject_Length(((PyObject *)__pyx_v_ridge_points)); if (unlikely(__pyx_t_2 == ((Py_ssize_t)-1))) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "poisson/discrete/_finite_volume.pyx":39
 * 
 *     for i in range(len(ridge_points)):
 *         for j, point in enumerate(ridge_points[i]):             # <<<<<<<<<<<<<<
 *             point_ridges[point].append(i)
 ...
 */
    __pyx_t_5 = 0;
    __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_ridge_points), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_6);
    if (likely(PyList_CheckExact(__pyx_t_6)) || PyTuple_CheckExact(__pyx_t_6)) {
      __pyx_t_7 = __pyx_t_6; __Pyx_INCREF(__pyx_t_7); __pyx_t_8 = 0;
      __pyx_t_9 = NULL;
    } else {
      __pyx_t_8 = -1; __pyx_t_7 = PyObject_GetIter(__pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 39, __pyx_L1_error)
    ...
    for (;;) {
      if (likely(!__pyx_t_9)) {
        if (likely(PyList_CheckExact(__pyx_t_7))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_6 = PyList_GET_ITEM(__pyx_t_7, __pyx_t_8); __Pyx_INCREF(__pyx_t_6); __pyx_t_8++; if (unlikely(0 < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
          #else
          __pyx_t_6 = PySequence_ITEM(__pyx_t_7, __pyx_t_8); __pyx_t_8++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          #endif
        } else {
          if (__pyx_t_8 >= PyTuple_GET_SIZE(__pyx_t_7)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_6 = PyTuple_GET_ITEM(__pyx_t_7, __pyx_t_8); __Pyx_INCREF(__pyx_t_6); __pyx_t_8++; if (unlikely(0 < 0)) __PYX_ERR(0, 39, __pyx_L1_error)
          #else
          __pyx_t_6 = PySequence_ITEM(__pyx_t_7, __pyx_t_8); __pyx_t_8++; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 39, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_6);
          #endif
      ...
      /* "poisson/discrete/_finite_volume.pyx":40
 *     for i in range(len(ridge_points)):
 *         for j, point in enumerate(ridge_points[i]):
 *             point_ridges[point].append(i)             # <<<<<<<<<<<<<<
 *             index_all[point].append(ridge_points[i][(j+1) % 2])
 * 
 */
      if (unlikely(__pyx_v_point_ridges == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
        __PYX_ERR(0, 40, __pyx_L1_error)
      }
      __pyx_t_6 = __Pyx_GetItemInt_List(__pyx_v_point_ridges, __pyx_v_point, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_12 = __Pyx_PyObject_Append(__pyx_t_6, __pyx_t_11); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;

      /* "poisson/discrete/_finite_volume.pyx":41
 *         for j, point in enumerate(ridge_points[i]):
 *             point_ridges[point].append(i)
 *             index_all[point].append(ridge_points[i][(j+1) % 2])             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_11 = __Pyx_GetItemInt_List(__pyx_v_index_all, __pyx_v_point, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_6 = __Pyx_GetItemInt(((PyObject *)__pyx_v_ridge_points), __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 1, 1); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_13 = __Pyx_mod_long((__pyx_v_j + 1), 2);
      __pyx_t_14 = __Pyx_GetItemInt(__pyx_t_6, __pyx_t_13, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_12 = __Pyx_PyObject_Append(__pyx_t_11, __pyx_t_14); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 41, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 */
    ...
    /* "poisson/discrete/_finite_volume.pyx":43
 *             index_all[point].append(ridge_points[i][(j+1) % 2])
 * 
 *         for vertex in ridge_vertices[i]:             # <<<<<<<<<<<<<<
 ...
 * 
 */
    if (unlikely(__pyx_v_ridge_vertices == Py_None)) {
      PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
      __PYX_ERR(0, 43, __pyx_L1_error)
    }
    __pyx_t_7 = __Pyx_GetItemInt_List(__pyx_v_ridge_vertices, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    if (likely(PyList_CheckExact(__pyx_t_7)) || PyTuple_CheckExact(__pyx_t_7)) {
      __pyx_t_14 = __pyx_t_7; __Pyx_INCREF(__pyx_t_14); __pyx_t_8 = 0;
      __pyx_t_9 = NULL;
    } else {
      __pyx_t_8 = -1; __pyx_t_14 = PyObject_GetIter(__pyx_t_7); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 43, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __pyx_t_9 = Py_TYPE(__pyx_t_14)->tp_iternext; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 43, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    for (;;) {
      if (likely(!__pyx_t_9)) {
        if (likely(PyList_CheckExact(__pyx_t_14))) {
          ...
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_7 = PyList_GET_ITEM(__pyx_t_14, __pyx_t_8); __Pyx_INCREF(__pyx_t_7); __pyx_t_8++; if (unlikely(0 < 0)) __PYX_ERR(0, 43, __pyx_L1_error)
          #else
          __pyx_t_7 = PySequence_ITEM(__pyx_t_14, __pyx_t_8); __pyx_t_8++; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          #endif
        } else {
          if (__pyx_t_8 >= PyTuple_GET_SIZE(__pyx_t_14)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_7 = PyTuple_GET_ITEM(__pyx_t_14, __pyx_t_8); __Pyx_INCREF(__pyx_t_7); __pyx_t_8++; if (unlikely(0 < 0)) __PYX_ERR(0, 43, __pyx_L1_error)
          #else
          __pyx_t_7 = PySequence_ITEM(__pyx_t_14, __pyx_t_8); __pyx_t_8++; if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 43, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_7);
          #endif
      ...
      /* "poisson/discrete/_finite_volume.pyx":44
 * 
 *         for vertex in ridge_vertices[i]:
 *             vertex_ridges[vertex].append(i)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      if (unlikely(__pyx_v_vertex_ridges == Py_None)) {
        PyErr_SetString(PyExc_TypeError, "'NoneType' object is not subscriptable");
        __PYX_ERR(0, 44, __pyx_L1_error)
      }
      __pyx_t_7 = __Pyx_GetItemInt_List(__pyx_v_vertex_ridges, __pyx_v_vertex, int, 1, __Pyx_PyInt_From_int, 1, 1, 1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 44, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 44, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_11);
      __pyx_t_12 = __Pyx_PyObject_Append(__pyx_t_7, __pyx_t_11); if (unlikely(__pyx_t_12 == ((int)-1))) __PYX_ERR(0, 44, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
 ...
 */
  ...
  /* "poisson/discrete/_finite_volume.pyx":46
 *             vertex_ridges[vertex].append(i)
 * 
 *     return point_ridges, index_all, vertex_ridges             # <<<<<<<<<<<<<<
 */
  ...
  __Pyx_GOTREF(__pyx_t_14);
  __Pyx_INCREF(__pyx_v_point_ridges);
  __Pyx_GIVEREF(__pyx_v_point_ridges);
  PyTuple_SET_ITEM(__pyx_t_14, 0, __pyx_v_point_ridges);
  __Pyx_INCREF(__pyx_v_index_all);
  __Pyx_GIVEREF(__pyx_v_index_all);
  PyTuple_SET_ITEM(__pyx_t_14, 1, __pyx_v_index_all);
  __Pyx_INCREF(__pyx_v_vertex_ridges);
  __Pyx_GIVEREF(__pyx_v_vertex_ridges);
  PyTuple_SET_ITEM(__pyx_t_14, 2, __pyx_v_vertex_ridges);
  __pyx_r = __pyx_t_14;
  __pyx_t_14 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("poisson.discrete._finite_volume.inverse_ridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_ridge_points.rcbuffer->pybuffer);
  __pyx_L2:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_cython_ridge_points, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
/* Python wrapper */
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_3inverse_ridge(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7poisson_8discrete_14_finite_volume_3inverse_ridge(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_ridge_points = 0;
  PyObject *__pyx_v_ridge_vertices = 0;
  PyObject *__pyx_v_point_ridges = 0;
  PyObject *__pyx_v_index_all = 0;
  PyObject *__pyx_v_vertex_ridges = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("inverse_ridge (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_ridge_points,&__pyx_n_s_ridge_vertices,&__pyx_n_s_point_ridges,&__pyx_n_s_index_all,&__pyx_n_s_vertex_ridges,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ridge_points)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ridge_vertices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inverse_ridge", 1, 5, 5, 1); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_point_ridges)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inverse_ridge", 1, 5, 5, 2); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_index_all)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inverse_ridge", 1, 5, 5, 3); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_vertex_ridges)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("inverse_ridge", 1, 5, 5, 4); __PYX_ERR(0, 31, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "inverse_ridge") < 0)) __PYX_ERR(0, 31, __pyx_L3_error)
      }
    ...
    __pyx_v_ridge_vertices = ((PyObject*)values[1]);
    __pyx_v_point_ridges = ((PyObject*)values[2]);
    __pyx_v_index_all = ((PyObject*)values[3]);
    __pyx_v_vertex_ridges = ((PyObject*)values[4]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("inverse_ridge", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 31, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("poisson.discrete._finite_volume.inverse_ridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ridge_points), __pyx_ptype_5numpy_ndarray, 1, "ridge_points", 0))) __PYX_ERR(0, 31, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_ridge_vertices), (&PyList_Type), 1, "ridge_vertices", 1))) __PYX_ERR(0, 31, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_point_ridges), (&PyList_Type), 1, "point_ridges", 1))) __PYX_ERR(0, 32, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_index_all), (&PyList_Type), 1, "index_all", 1))) __PYX_ERR(0, 32, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_vertex_ridges), (&PyList_Type), 1, "vertex_ridges", 1))) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_r = __pyx_pf_7poisson_8discrete_14_finite_volume_2inverse_ridge(__pyx_self, __pyx_v_ridge_points, __pyx_v_ridge_vertices, __pyx_v_point_ridges, __pyx_v_index_all, __pyx_v_vertex_ridges);
...
static PyObject *__pyx_pf_7poisson_8discrete_14_finite_volume_2inverse_ridge(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_ridge_points, PyObject *__pyx_v_ridge_vertices, PyObject *__pyx_v_point_ridges, PyObject *__pyx_v_index_all, PyObject *__pyx_v_vertex_ridges) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_ridge_points;
  __Pyx_Buffer __pyx_pybuffer_ridge_points;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_ridge_points.diminfo[0].strides = __pyx_pybuffernd_ridge_points.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_ridge_points.diminfo[0].shape = __pyx_pybuffernd_ridge_points.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_ridge_points.diminfo[1].strides = __pyx_pybuffernd_ridge_points.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_ridge_points.diminfo[1].shape = __pyx_pybuffernd_ridge_points.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_7poisson_8discrete_14_finite_volume_inverse_ridge(__pyx_v_ridge_points, __pyx_v_ridge_vertices, __pyx_v_point_ridges, __pyx_v_index_all, __pyx_v_vertex_ridges, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "poisson.discrete._finite_volume.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._finite_volume.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._finite_volume.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._finite_volume._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"fneig", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7poisson_8discrete_14_finite_volume_1fneig, METH_VARARGS|METH_KEYWORDS, 0},
  {"inverse_ridge", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7poisson_8discrete_14_finite_volume_3inverse_ridge, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__finite_volume(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__finite_volume},
  {0, NULL}
};
#endif
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "_finite_volume",
    __pyx_k_TODO_refactor_and_write_Docstri, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_index_all, __pyx_k_index_all, sizeof(__pyx_k_index_all), 0, 0, 1, 1},
  {&__pyx_n_s_index_keep, __pyx_k_index_keep, sizeof(__pyx_k_index_keep), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_point_ridges, __pyx_k_point_ridges, sizeof(__pyx_k_point_ridges), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_vertex_ridges, __pyx_k_vertex_ridges, sizeof(__pyx_k_vertex_ridges), 0, 0, 1, 1},
 ...
 *     cdef int [:] points_in = t
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_n_s_i); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 17, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_finite_volume(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_finite_volume(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__finite_volume(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__finite_volume(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__finite_volume(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_finite_volume' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__finite_volume(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_finite_volume", __pyx_methods, __pyx_k_TODO_refactor_and_write_Docstri, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_poisson__discrete___finite_volume) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "poisson.discrete._finite_volume")) {
      if (unlikely(PyDict_SetItemString(modules, "poisson.discrete._finite_volume", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "poisson/discrete/_finite_volume.pyx":5
 * '''
 ...
 */
  ...
  /* "poisson/discrete/_finite_volume.pyx":7
 * import numpy as np
 * cimport numpy as np
 * import time             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "poisson/discrete/_finite_volume.pyx":1
 * '''             # <<<<<<<<<<<<<<
 *     TODO: refactor and write Docstring
 * '''
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init poisson.discrete._finite_volume", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init poisson.discrete._finite_volume");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
