...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "name": "poisson.discrete._linear_problem",
        "sources": [
            "poisson/discrete/_linear_problem.pyx"
        ]
    },
    "module_name": "poisson.discrete._linear_problem"
}
END: Cython Metadata */
...
#define __PYX_HAVE__poisson__discrete___linear_problem
#define __PYX_HAVE_API__poisson__discrete___linear_problem
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'poisson.discrete._linear_problem' */
...
static PyObject *__pyx_f_7poisson_8discrete_15_linear_problem_indices_from_indtpr(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "poisson.discrete._linear_problem"
extern int __pyx_module_is_main_poisson__discrete___linear_problem;
int __pyx_module_is_main_poisson__discrete___linear_problem = 0;

/* Implementation of 'poisson.discrete._linear_problem' */
...
static const char __pyx_k_indtpr[] = "indtpr";
...
static PyObject *__pyx_n_s_indtpr;
...
static PyObject *__pyx_pf_7poisson_8discrete_15_linear_problem_indices_from_indtpr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_indtpr, int __pyx_v_size); /* proto */
...
/* "poisson/discrete/_linear_problem.pyx":5
...
static PyObject *__pyx_pw_7poisson_8discrete_15_linear_problem_1indices_from_indtpr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7poisson_8discrete_15_linear_problem_indices_from_indtpr(__Pyx_memviewslice __pyx_v_indtpr, int __pyx_v_size, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_d;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("indices_from_indtpr", 0);
  ...
  /* "poisson/discrete/_linear_problem.pyx":21
 *     cdef int i
 *     cdef int d
 ...
 */
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_4);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_indices.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
  ...
  /* "poisson/discrete/_linear_problem.pyx":23
 *     cdef npc.ndarray[npc.int_t, ndim=1] indices = np.zeros((size), dtype=int)
 * 
 *     for i in range(indtpr.shape[0] - 1):             # <<<<<<<<<<<<<<
 ...
 *             indices[d] = i
 */
  __pyx_t_6 = ((__pyx_v_indtpr.shape[0]) - 1);
  __pyx_t_7 = __pyx_t_6;
  for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
    __pyx_v_i = __pyx_t_8;

    /* "poisson/discrete/_linear_problem.pyx":24
 * 
 *     for i in range(indtpr.shape[0] - 1):
 *         for d in range(indtpr[i], indtpr[i + 1]):             # <<<<<<<<<<<<<<
 *             indices[d] = i
 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_indtpr.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_indtpr.shape[0])) __pyx_t_10 = 0;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    __pyx_t_10 = (*((int *) ( /* dim=0 */ (__pyx_v_indtpr.data + __pyx_t_9 * __pyx_v_indtpr.strides[0]) )));
    __pyx_t_9 = __pyx_v_i;
    __pyx_t_11 = -1;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_v_indtpr.shape[0];
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_9 >= __pyx_v_indtpr.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
      __PYX_ERR(0, 24, __pyx_L1_error)
    }
    __pyx_t_11 = __pyx_t_10;
    for (__pyx_t_12 = (*((int *) ( /* dim=0 */ (__pyx_v_indtpr.data + __pyx_t_9 * __pyx_v_indtpr.strides[0]) ))); __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      __pyx_v_d = __pyx_t_12;

      /* "poisson/discrete/_linear_problem.pyx":25
 *     for i in range(indtpr.shape[0] - 1):
 *         for d in range(indtpr[i], indtpr[i + 1]):
 *             indices[d] = i             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      } else if (unlikely(__pyx_t_13 >= __pyx_pybuffernd_indices.diminfo[0].shape)) __pyx_t_14 = 0;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int_t *, __pyx_pybuffernd_indices.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_indices.diminfo[0].strides) = __pyx_v_i;
    }
  }

  /* "poisson/discrete/_linear_problem.pyx":27
 *             indices[d] = i
 * 
 *     return indices             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("poisson.discrete._linear_problem.indices_from_indtpr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_indices.rcbuffer->pybuffer);
...
static PyObject *__pyx_pw_7poisson_8discrete_15_linear_problem_1indices_from_indtpr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("indices_from_indtpr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_indtpr,&__pyx_n_s_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_indtpr)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("indices_from_indtpr", 1, 2, 2, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "indices_from_indtpr") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_indtpr = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_indtpr.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_size = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_size == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("indices_from_indtpr", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("poisson.discrete._linear_problem.indices_from_indtpr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7poisson_8discrete_15_linear_problem_indices_from_indtpr(__pyx_self, __pyx_v_indtpr, __pyx_v_size);
...
static PyObject *__pyx_pf_7poisson_8discrete_15_linear_problem_indices_from_indtpr(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_indtpr, int __pyx_v_size) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("indices_from_indtpr", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_indtpr.memview)) { __Pyx_RaiseUnboundLocalError("indtpr"); __PYX_ERR(0, 5, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_7poisson_8discrete_15_linear_problem_indices_from_indtpr(__pyx_v_indtpr, __pyx_v_size, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_indtpr, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "poisson.discrete._linear_problem.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._linear_problem.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._linear_problem.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "poisson.discrete._linear_problem._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"indices_from_indtpr", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7poisson_8discrete_15_linear_problem_1indices_from_indtpr, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7poisson_8discrete_15_linear_problem_indices_from_indtpr},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec__linear_problem(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec__linear_problem},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_indtpr, __pyx_k_indtpr, sizeof(__pyx_k_indtpr), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC init_linear_problem(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC init_linear_problem(void)
#else
__Pyx_PyMODINIT_FUNC PyInit__linear_problem(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit__linear_problem(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec__linear_problem(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module '_linear_problem' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit__linear_problem(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_linear_problem", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_poisson__discrete___linear_problem) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "poisson.discrete._linear_problem")) {
      if (unlikely(PyDict_SetItemString(modules, "poisson.discrete._linear_problem", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "poisson/discrete/_linear_problem.pyx":2
 ...
 */
  ...
  /* "poisson/discrete/_linear_problem.pyx":1
 * from cython cimport view             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as npc
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init poisson.discrete._linear_problem", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init poisson.discrete._linear_problem");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
