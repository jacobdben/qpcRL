...
parameter_pixels = qc.Parameter(name='BNC_12_15_5_18_48_3_2',label='BNC_12_15_5_18_48_3_2',unit='V', set_cmd=parameter_pixels_set)
...
def func_to_minimize(x,table): #x len 7
    ...
    val=stairs.stairLossFunk2(np.flip(result))#+stairs.L_1_regularization(voltages, 0.001)+stairs.L_2_regularization(voltages, 0.001)
...
voltages_plot[0:2]=voltages[np.argmin(losses)][0:2]
voltages_plot[3:6]=voltages[np.argmin(losses)][2:5]
voltages_plot[6:8]=voltages[np.argmin(losses)][5:7]

voltages_plot[2]=np.nan
voltages_plot[8]=np.nan

voltages_plot[0:2]=voltages[7941-7216][0:2]
voltages_plot[3:6]=voltages[7941-7216][2:5]
voltages_plot[6:8]=voltages[7941-7216][5:7]
